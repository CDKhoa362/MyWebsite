...
namespace MyWebsite.Areas.Admin.Controllers.Location
{
    ...
    public class WardController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, int page = 1, int pageSize = 50)
        {
            ...
            {
                query = query.Where(w => EF.Functions.Collate(w.WardName, "SQL_Latin1_General_CP1_CI_AI").Contains(searchString) ||
                                         EF.Functions.Collate(w.District != null ? w.District.DistrictName : "", "SQL_Latin1_General_CP1_CI_AI").Contains(searchString) ||
                                         w.WardId.Contains(searchString));
            }
